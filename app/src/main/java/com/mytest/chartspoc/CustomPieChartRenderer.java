...
class CustomPieChartRenderer extends DataRenderer {
...
//------------------------
               /* SpannableString s1 = new SpannableString("bold\n");
                ...
                s1.setSpan(new RelativeSizeSpan(2), 0, 3, flag);
                s2.setSpan(new ForegroundColorSpan(Color.RED), 0, 3, flag);
                ...
                int index = centerText.toString().indexOf("\n");

                Spannable tempSpannable = new SpannableString(centerText);
                tempSpannable.setSpan(new RelativeSizeSpan(0.7f), index, centerText.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                tempSpannable.setSpan(new ForegroundColorSpan(Color.parseColor("#999999")),
                        index, centerText.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                /*tempSpannable.setSpan(new RelativeSizeSpan(0.75f),
                ...
                mCenterTextLayout = new StaticLayout(tempSpannable, 0, centerText.length(),
                        ...
                        Layout.Alignment.ALIGN_OPPOSITE, 1.f, 0.f, false);
